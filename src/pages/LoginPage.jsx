    ...
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-gradient-to-br from-[#0e0a1f] via-[#150f2b] to-[#06040d] text-white">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-white/50 mt-1.5">Open your capsule to relive your locked chapters.</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2 px-1">
                ...
                <Link to="/forgot-password" className="text-xs text-pink-400 hover:text-pink-300 font-medium">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 text-center border-t border-white/5 pt-6 text-sm text-white/50">
            ...
            <Link to="/signup" className="text-pink-400 hover:text-pink-300 font-bold">
              Sign Up Free
            </Link>
          </div>
        </div>
